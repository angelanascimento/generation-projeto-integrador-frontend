...
import Image06 from "../../assets/img/photos-about/photo-06.jpg"
    ...
    return(
        <div className="w-full xl:w-2/5">
            <div className="grid grid-cols-8 grid-rows-7 gap-1.5 mb-16  xl:mb-0">
                ...
                row-start-3 row-span-2 h-full" src={Image06} alt="Fotografia de dois caixotes de vegeitas, sendo o de baixo com pepinos e o de cima com tomates pequenos" />
