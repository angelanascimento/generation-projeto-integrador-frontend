                        ...
                        <div className='w-full flex text-center justify-center' >
                                <div className='font-medium text-orange-600 w-[29.5rem] md:w-[30rem]  lg:w-[30.5rem] xl:w-[31rem]'>
                                    ...
                                    <div className='flex justify-around mt-5'>
                                        <button className='bg-lime-950 rounded-md p-3.5 w-44 md:w-52 xl:w-52  text-white hover:bg-white
                                        hover: border-2 border-lime-950 hover:text-black transition-all'>Conheça nossos produtos</button>
                                        <button className='bg-lime-950 rounded-md p-3.5 w-44 md:w-52 xl:w-52 text-white hover:bg-white
                                        hover: border-2 border-lime-950 hover:text-black transition-all'>Conheça nossos  fornecedores</button>
                                    </div>
                                </div>
                            </div>
                        </div>
